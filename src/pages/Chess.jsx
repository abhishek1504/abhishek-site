  ...
  return (
    <div className="page fade-in">
      <div className="section chess-section">
        ...
        {/* Trophy photo */}
        <div style={{ marginTop: 56, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2, background: "var(--gray-1)", maxWidth: 800 }}>
          ...
          <div style={{ background: "var(--gray-1)", padding: "40px 32px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: "var(--gold)", letterSpacing: 3, marginBottom: 16 }}>ACHIEVEMENT</div>
            <div style={{ fontFamily: "'Nunito', sans-serif", fontWeight: 800, fontSize: 42, color: "var(--white)", lineHeight: 0.95, marginBottom: 16 }}>PBEL CHESS CHAMPIONSHIP 2025</div>
            <div style={{ fontSize: 14, color: "var(--gray-4)", lineHeight: 1.7, marginBottom: 24 }}>
        ...
        <div className="brand-card" style={{ marginTop: 56, maxWidth: 800 }}>
          ...
          <p>
            ...
            both are about <strong style={{ color: "var(--white)" }}>showing up consistently</strong>,
        ...
        <div style={{ marginTop: 64, maxWidth: 800 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2, background: "var(--gray-1)" }}>
            {[
              ...
              <div key={move} style={{ display: "grid", gridTemplateColumns: "48px 1fr 1fr", gap: 20, padding: "20px 24px", background: "var(--black)", alignItems: "start" }}>
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 14, color: "var(--gold)" }}>{move}</div>
                <div style={{ fontSize: 15, fontWeight: 600, color: "var(--white)" }}>{lesson}</div>
                <div style={{ fontSize: 14, color: "var(--gray-4)", lineHeight: 1.6 }}>{apply}</div>
              </div>
            ))}
          </div>
        </div>
